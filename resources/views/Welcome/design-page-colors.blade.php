                ...
                <div class="col-lg-7 design-page-left">
                    <div class="design-tab">
                        <ul>
                            ...
                            <li class="active"><a href="{{route('welcome.design-page-background')}}">
                    ...
                    <div class="size-sec">
                        <div class="ourwork-tab">
                            <ul class="resp-tabs-list hor_1 e-tab">
                                <li>MATERIAL</li>           
                                <li class="resp-tab-active">COLORS</li>            
                                <li>CUSTOM</li>                     
                            </ul>

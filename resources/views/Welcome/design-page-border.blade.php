                ...
                <div class="col-lg-7 design-page-left">
                    <div class="design-tab">
                        <ul>
                            ...
                            <li class="active"><a href="{{route('welcome.design-page-border')}}">
                            ...
                            <ul>
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            ...
                                            <span><img src="{{asset('welcome_assets/images/border01.png')}}" alt=""></span>
                                        </label>
                                ...
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            <input type="radio" name="name">
                                            <span><img src="{{asset('welcome_assets/images/border02.png')}}" alt=""></span>
                                        </label>
                                ...
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            <input type="radio" name="name">
                                            <span><img src="{{asset('welcome_assets/images/border03.png')}}" alt=""></span>
                                        </label>
                                ...
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            <input type="radio" name="name">
                                            <span><img src="{{asset('welcome_assets/images/border04.png')}}" alt=""></span>
                                        </label>
                                ...
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            <input type="radio" name="name">
                                            <span><img src="{{asset('welcome_assets/images/border05.png')}}" alt=""></span>
                                        </label>
                                        <span>No Border</span>
                                    </div>
                                </li>

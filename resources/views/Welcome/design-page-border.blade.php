                            ...
                            <ul>
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            ...
                                            <span><img src="images/border01.png" alt=""></span>
                                        </label>
                                ...
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            <input type="radio" name="name">
                                            <span><img src="images/border02.png" alt=""></span>
                                        </label>
                                ...
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            <input type="radio" name="name">
                                            <span><img src="images/border03.png" alt=""></span>
                                        </label>
                                ...
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            <input type="radio" name="name">
                                            <span><img src="images/border04.png" alt=""></span>
                                        </label>
                                ...
                                <li>
                                    <div class="form_input_radio">
                                        <label>
                                            <input type="radio" name="name">
                                            <span><img src="images/border05.png" alt=""></span>
                                        </label>
                                        <span>No Border</span>
                                    </div>
                                </li>

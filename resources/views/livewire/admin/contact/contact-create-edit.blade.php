<x-admin.form-section submit="saveOrUpdate">
    <x-slot name="form">
                    <x-admin.form-group>
                        ...
                        <x-admin.input type="text" wire:model.defer="full_name" placeholder="full name"  class="{{ $errors->has('full_name') ? 'is-invalid' :'' }}" />
                        <x-admin.input-error for="full_name" />
                    </x-admin.form-group>

                    <x-admin.form-group>
                        <x-admin.lable value="Email" required />
                        <x-admin.input type="text" wire:model.defer="email" placeholder="email"  class="{{ $errors->has('email') ? 'is-invalid' :'' }}" />
                        <x-admin.input-error for="email" />
                    </x-admin.form-group>

                    <x-admin.form-group>
                        <x-admin.lable value="Phone" required />
                        <x-admin.input type="text" wire:model.defer="phone" placeholder="phone"  class="{{ $errors->has('phone') ? 'is-invalid' :'' }}" />
                    ...
                    <x-admin.form-group>
                        ...
                        <x-admin.input type="text" wire:model.defer="state" placeholder="state"  class="{{ $errors->has('state') ? 'is-invalid' :'' }}" />
                        <x-admin.input-error for="state" />
                    </x-admin.form-group>
                    <x-admin.form-group>
                        <x-admin.lable value="City" required />
                        <x-admin.input type="text" wire:model.defer="city" placeholder="city"  class="{{ $errors->has('city') ? 'is-invalid' :'' }}" />
                        <x-admin.input-error for="city" />
                    </x-admin.form-group>

                    <x-admin.form-group>
                        <x-admin.lable value="Zip" required />
                        <x-admin.input type="text" wire:model.defer="zip" placeholder="zip"  class="{{ $errors->has('zip') ? 'is-invalid' :'' }}" />
                        <x-admin.input-error for="zip" />
                    </x-admin.form-group>

                    <x-admin.form-group>
                        <x-admin.lable value="Subject" required />
                        <x-admin.input type="text" wire:model.defer="subject" placeholder="subject"  class="{{ $errors->has('subject') ? 'is-invalid' :'' }}" />
    ...
    <x-slot name="actions">
        ...
        <x-admin.link :href="route('contact-form.index')" color="secondary">Cancel</x-admin.link>
    </x-slot>
</x-form-section>
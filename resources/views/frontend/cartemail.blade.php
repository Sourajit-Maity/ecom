            ...
            <table border="0" style="width: 600px; margin: 0 auto; border-collapse: collapse;color:#fff;">
                ...
                <tr>
                    <td style="padding: 10px 10px 0px 10px; text-align: left;" valign="top">
                        ...
                        <p style="font-size: 9pt; line-height: 20px; margin: 0px 0px 10px 0px;">If you need further assistance with your order, please visit Customer Service.</p>
                        <p style="font-size: 9pt; line-height: 20px; margin: 0px 0px 10px 0px;">We hope to see you again soon!</p>
                    ...
                    <td style="padding: 10px 10px 0px 10px; text-align: left;" valign="top">
                        ...
                        <p style="font-size: 9pt; line-height: 20px; margin: 0px 0px 10px 0px;"><a style="color: #fff; text-decoration: none;" href="mailto:sourajitm8@gmail.com" target="_blank">sourajitm8@gmail.com</a></p>
